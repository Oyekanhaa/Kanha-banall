...
Owner = "SHIVANSH39"
repo = "https://github.com/Oyekanhaa/Kanha-banall.git"
@sree.on(events.NewMessage(pattern="^/start"))
async def start(event):
    buttns = [Button.url("••sᴜᴘᴘᴏʀᴛ••", "https://t.me/kanhasworld"), Button.url("••ᴜᴘᴅᴀᴛᴇs••", "https://t.me/aboutkanha"), Button.url("••ʀᴇᴘᴏ••", f'{repo}')]
    py = platform.python_version()
    if event.sender.id in OP:
        await sree.send_file(
            event.chat.id,
            file="https://files.catbox.moe/h2cidx.jpg",
...
async def start(event):
    buttns = [Button.url("••sᴜᴘᴘᴏʀᴛ••", "https://t.me/kanhasworld"), Button.url("••ᴜᴘᴅᴀᴛᴇs••", "https://t.me/aboutkanha"),
    ...
    if event.sender.id not in OP:
        await event.reply(
            "ʜᴜʜ ɴɪɢɢᴀ!\ɴᴛʜɪs ɪs ɴᴏᴛ ғᴏʀ ʏᴏᴜ ʟᴏʟ 😑\n\ɴᴍᴀᴋᴇ ʏᴏᴜʀ ᴏᴡɴ ʙᴏᴛ ғʀᴏᴍ ᴛʜɪs [ʀᴇᴘᴏsɪᴛᴏʀʏ⚡](https://github.com/Oyekanhaa/Kanha-banall.git)",
            link_preview=False,
        )       
...
print("ᴊᴏɪɴ @aboutkanha ɪғ ʏᴏᴜ ғᴀᴄɪɴɢ ᴀɴʏ ᴋɪɴᴅ ᴏғ ɪssᴜᴇ!!")
